...
public sealed class TerminationIsNotPossibleUntilThreeMonthsHaveElapsedRuleTests
{
    ...
    internal void Given_terminate_When_three_months_have_not_elapsed_Then_it_is_not_possible_to_terminate(DateTimeOffset signDate,
        DateTimeOffset nowDate)
    {
        ...
        var act = () =>
            BusinessRuleValidator.Validate(
                new TerminationIsNotPossibleUntilThreeMonthsHaveElapsedRule(signDate, nowDate));
    ...
    internal void Given_terminate_When_three_months_have_elapsed_Then_it_is_possible_to_terminate(DateTimeOffset signDate,
        DateTimeOffset nowDate)
    {
        // Arrange
