...
[NOTE]
===
You propably have heard about Anemic Domain Model. This is a known as anti-pattern. It is a entity that has only properties and no behavior. All business logic is placed in the service layer. This is not a good practice. We should avoid it. 
===
