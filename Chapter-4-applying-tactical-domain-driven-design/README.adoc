...
Large part of the process is a strategic part. That shows us how important it is to understand the problem space before we start coding. Tactical part is only a small part of the whole process, but still essential to building good quality software. 
