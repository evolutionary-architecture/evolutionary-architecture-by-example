...
2. After the _Contract_ is signed, __Binding Contract__ is created. It has the force of law and binds the customer with us.
...
5. Annex can only be attached if __Binding Contract__ is active - has not yet expired or was not terminated.
...
- They Represents of essential business concept
- Enforce bussiness rules and invariants of internal inside
- They have a unique identity
...
==== Why Aggregate Roots should be lightweight?
TODO:
