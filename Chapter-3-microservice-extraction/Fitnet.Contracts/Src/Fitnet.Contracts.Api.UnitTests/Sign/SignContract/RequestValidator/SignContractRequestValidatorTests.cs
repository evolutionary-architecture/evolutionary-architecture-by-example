namespace EvolutionaryArchitecture.Fitnet.Contracts.Api.UnitTests.Sign.SignContract.RequestValidator;

using EvolutionaryArchitecture.Fitnet.Contracts.Api.Sign;
