    ...
    where TIntegrationEvent : IIntegrationEvent
{
    ...
    public IntegrationEventHandlerScope(IApplicationFactory applicationInMemoryFactory)
    {
        _serviceScope = applicationInMemoryFactory.ServiceProvider.CreateScope();
